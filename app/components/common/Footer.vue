<template>
          ...
          <div class="col-lg-12">
            <div class="copyright-1">
              <p class="disc">
                ...
                <a href="/">Vibrantick Infotech Solutions</a> | <br class="d-xl-none d-lg-none"> All Right
                Reserved
              </p>
  ...
  <div class="progress-wrap active-progress">
    <svg class="progress-circle svg-content" width="100%" height="100%" viewBox="-1 -1 102 102">
        <path d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98" style="transition: stroke-dashoffset 10ms linear; stroke-dasharray: 307.919, 307.919; stroke-dashoffset: 243.501;">
        </path>
    </svg>
</div>
</template>
