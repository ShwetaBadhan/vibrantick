        ...
        <div class="row align-items-center">
          <div class="col-lg-12">
            ...
            <div class="policies-container">
              <p>
                <strong> Welcome to Vibrantick Infotech Solutions!</strong
                ><br />
                These terms and conditions outline the rules and regulations for
                the use of Vibrantick Infotech Solutions's Website, located
                here.<br />
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Vibrantick Infotech Solutions
              ...
              <p>
                We employ the use of cookies. By accessing Vibrantick Infotech
                Solutions, you agreed to use cookies in agreement with the
                Vibrantick Infotech Solutions's Privacy Policy.<br />
              ...
              <p>
                Unless otherwise stated, Vibrantick Infotech Solutions and/or
                its licensors own the intellectual property rights for all
                material on Vibrantick Infotech Solutions. All intellectual
                property rights are reserved. You may access this from
                Vibrantick Infotech Solutions for your own personal use
                subjected to restrictions set in these terms and conditions.
                <br>
                You must not:
                <ul>
                    <li>
                        Republish material from Vibrantick Infotech Solutions</li>
                    <li>

                        Sell, rent or sub-license material from Vibrantick Infotech Solutions</li>

                        <li>

                            Reproduce, duplicate or copy material from Vibrantick Infotech Solutions</li>

                            <li>

                                Redistribute content from Vibrantick Infotech Solutions</li>
                </ul>
              </p>
...
No use of Vibrantick Infotech Solutions's logo or other artwork will be allowed for linking absent a trademark license agreement.
</p>
